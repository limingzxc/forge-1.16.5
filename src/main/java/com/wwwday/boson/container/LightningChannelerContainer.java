...
public class LightningChannelerContainer extends Container {
    ...
    public boolean isLightningStorm() {
        return Objects.requireNonNull(tileEntity.getLevel()).isThundering();
    }

    @Override
    public boolean stillValid(PlayerEntity playerIn) {
        return stillValid(IWorldPosCallable.create(Objects.requireNonNull(tileEntity.getLevel()), tileEntity.getBlockPos()),
