...
public class TestScreen extends ContainerScreen<TestContainer> implements IHasContainer<TestContainer> {

    private static final ResourceLocation GUI = new ResourceLocation("textures/gui/container/generic_54.png");
    private final int containerRows;

    public TestScreen(TestContainer pMenu, PlayerInventory pPlayerInventory, ITextComponent pTitle) {
